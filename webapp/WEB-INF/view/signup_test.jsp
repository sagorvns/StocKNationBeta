		...
		<div class="container">
			...
			<form:form action="saveUser" modelAttribute="user" method="POST">
				...
				<span class="input input--kuro">
					<input name="firstName" class="input__field input__field--kuro kuro_w3" type="text" id="input-7" placeholder="" required=""/>
				...
				<span class="input input--kuro">
					<input name="lastName" class="input__field input__field--kuro kuro_w3" type="text" id="input-8" placeholder="" required="">
				...
				<span class="input input--kuro">
					<input name="email" class="input__field input__field--kuro kuro_w3" type="email" id="input-9" placeholder="" required="">
				...
				<span class="input input--kuro">
					<input name="password" class="input__field input__field--kuro kuro_w3" type="password" id="input-10" placeholder="" required="">
				...
				<span class="input input--kuro">
					<input name="con_password" class="input__field input__field--kuro kuro_w3" type="password" id="input-11" placeholder="" required="">
